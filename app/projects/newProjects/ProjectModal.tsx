...
export const ProjectModal = ({
  ...
  const content = (
    <div className="fixed top-0 left-0 right-0 z-[1000000] h-screen py-[4.8rem] px-[1.2rem] bg-black/25 backdrop-blur-md overflow-y-scroll flex justify-center cursor-pointer" onClick={() => setIsOpen(false)}>
      ...
      >
        ...
        <div className='sm:p-[2.4rem] p-5'>
          ...
          <div className='flex flex-col gap-[1.2rem] text-base text-gray-600 dark:text-gray-200
          '>{modalContent}</div>
          ...
          <div className="mt-[2.4rem]">
            ...
            <div className='flex flex-col sm:flex-row sm:items-center sm:gap-[1.2rem] gap-[.5rem]'>
              ...
              <Link target="_blank" rel="nofollow" className="flex   items-center  gap-[0.4rem] text-lg text-primary-400 hover:underline" href={projectLink}>
